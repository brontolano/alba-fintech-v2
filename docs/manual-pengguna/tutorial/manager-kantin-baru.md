# Tutorial — Manager Kantin Baru

Akun: `manager.kantinbaru@alba.app` / `bismillah`

## 1. Cara Login

1. Buka aplikasi di browser HP.
2. Isi **Email** `manager.kantinbaru@alba.app` dan **Password** `bismillah`.
3. Ketuk **Masuk**.
...
![Dashboard](screenshots/mbaru-dashboard.png)
...
![Shift saya](screenshots/mbaru-shift.png)
...
![Review stok masuk](screenshots/mbaru-review.png)
...
![Belanja stok](screenshots/mbaru-belanja.png)

## 7. Memeriksa Inventori

1. Buka `Kelola → Inventori` untuk stok Kantin Baru.

![Inventori](screenshots/mbaru-inventory.png)
