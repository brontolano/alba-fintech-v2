# Tutorial — Staff Kantin Baru

Akun: `staff.kantinbaru@alba.app` / `bismillah`

## 1. Cara Login

1. Buka aplikasi di browser HP.
2. Isi **Email** `staff.kantinbaru@alba.app` dan **Password** `bismillah`.
3. Ketuk **Masuk**.
...
![Shift saya](screenshots/sbaru-shift.png)
...
![Stok masuk](screenshots/sbaru-stokmasuk.png)
...
![Hitung sisa](screenshots/sbaru-sisa.png)
...
![Stok](screenshots/sbaru-inventory.png)
